...
// Source: /home/yathakka/go/src/github.com/aws/amazon-vpc-resource-controller-k8s/pkg/provider/branch/trunk/trunk.go
...
func (m *MockTrunkENI) CreateAndAssociateBranchENIs(pod *v1.Pod, securityGroups []string, eniCount int) ([]*trunk.ENIDetails, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAndAssociateBranchENIs", pod, securityGroups, eniCount)
...
func (mr *MockTrunkENIMockRecorder) CreateAndAssociateBranchENIs(pod, securityGroups, eniCount interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAndAssociateBranchENIs", reflect.TypeOf((*MockTrunkENI)(nil).CreateAndAssociateBranchENIs), pod, securityGroups, eniCount)
}
